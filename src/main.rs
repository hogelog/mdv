...
<main class="home-main"><section class="hero"><p class="eyebrow">Markdown, locally</p><h1>Read Markdown in your browser.</h1><p>Pass a local file to <code>mdv</code>. It stays on your machine and opens here with a clean, readable layout.</p><pre><code>mdv path/to/file.md</code></pre></section>
